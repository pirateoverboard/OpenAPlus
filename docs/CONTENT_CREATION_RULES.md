...
When the official CompTIA objective wording supports broad troubleshooting
practice, longer spoken-answer practice belongs in objective-local
`interview/` files rather than regular Anki cards. See
