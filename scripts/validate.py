"""Validate all OpenAPlus source cards."""

import argparse
from pathlib import Path

from openaplus.content_pipeline import format_issue, validate_cards
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not result.valid:
        ...
        return 1
    print(f"Validation passed. {len(result.cards)} card(s) checked.")
    return 0
