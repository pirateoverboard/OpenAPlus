# Contributing to OpenAPlus

Thank you for contributing. Keep changes focused, tested, and reviewable.

## Development workflow

1. Create a branch from the default branch.
2. Install the Python and website dependencies described in the README.
3. Add tests for behavior changes.
4. Run the Python checks and the Docusaurus production build locally.
5. Open a pull request using the repository template.

## Content policy

Educational contributions must be original or compatible with CC BY 4.0 and
